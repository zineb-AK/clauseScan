...
Téléchargement d'un rapport PDF d'une analyse (US14). Endpoint dédié avec contrôle d'accès via Sanctum et policy, vérification du statut `done` avant génération, retour du fichier en téléchargement direct.

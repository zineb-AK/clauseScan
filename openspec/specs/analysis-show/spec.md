...
Consultation des résultats d'analyse d'un contrat (US12). Endpoint dédié avec contrôle d'accès via Sanctum et policy, retour conditionnel selon le statut de l'analyse.

...
Coquille applicative React : structure Vite + React Router, layout principal avec navigation, design system minimal (couleurs, typographie, composants de base), instance Axios avec intercepteurs, provider TanStack Query, et contexte d'authentification. Pré-requis transverse à toutes les fonctionnalités frontend.

...
Pages React d'inscription et de connexion avec formulaires React Hook Form + Zod, validation frontend, affichage des erreurs API, et redirection post-authentification.
